...
- Next permitted action: User prüft die implementierte freie Scroll-Choreografie auf `/`. Die frühere Ein-Gestus-pro-Station-Vorgabe ist durch den ausdrücklichen Implementierungsauftrag aufgehoben. Nach Bewegungsfreigabe Ticket 11 schließen und Ticket 12 beginnen.
...
- Last visual evidence: Browserprüfung 2026-09-06 bei 1280 × 720, 1920 × 2160 und 390 × 844. Freier Vorwärts-/Rückwärtslauf und L-Ausstieg ohne Wheel-Sperre oder CSS-Snapping; 50 Folgeimpulse laufen durch L hindurch. S/M/L-Lesepositionen 1136/1443/1750 px, L-Parkstrecke rund 156 px, gesamte Modellreise rund 2007 statt 2310 px. Desktopintro kollisionsfrei links; Reload bleibt bei 1260 px. Hoher Desktop hält rund 178 px an L und S startet kongruent im Hero. Mobile statisch, Reduced-Motion-Wechsel per Controller-Test geprüft. Lint, TypeScript, 49 Tests und statischer Build grün. Standards- und Spec-Review ohne offene Befunde; einmaliger Detector dieser Korrektur ohne Befunde. Voller Nachweis: `docs/design/motion-diagnosis-2026-09-06.md`.
