...
- Current primary source: `.scratch/startseite/issues/11-leitwagen-motion-reduced-motion.md`, auf Basis von `docs/design/direction-contract-home.md` und der statisch freigegebenen Produktionsroute `/`.
- Next permitted action: Ticket 11 umsetzen: die Leitwagen-Choreografie und ihre gleichwertigen Mobile- und Reduced-Motion-Fassungen verfeinern. Danach folgt Ticket 12 mit finalem Review und Auslieferung.
- Open decision or blocker: Das Timing und Bewegungsgefühl aus Ticket 11 benötigen nach Umsetzung die Bestätigung des Users. Go-live bleibt zusätzlich blockiert, bis Registergericht und eine gegebenenfalls erforderliche MStV-Verantwortung bestätigt, die Rechtstexte final geprüft und Hetzner-AVV/Logkonfiguration geklärt sind. Der produktive PHP-Mailer wurde vom User ausdrücklich auf später verschoben und bleibt vor echtem Formularversand ein eigener Go-live-Blocker. Finale maßhaltige M-/L-Freisteller bleiben austauschbar.
- Last visual evidence: Der vollständige statische Export wurde am 2026-09-05 bei Desktop 1440 × 900, breitem Desktop 1708 × 1260, Tablet 900 × 1024 und Mobile 390 × 844 vollständig gescrollt; Startseite, Impressum, Datenschutz und eine echte No-JS-Mobile-Ansicht sind ohne materiellen Layoutbruch geprüft. Die anschließend ergänzten S/M/L-Stationslinien und die verbundene Aufstellungsplanung wurden bei 1708 × 1260 und 390 × 844 nochmals separat visuell geprüft. Keine echte horizontale Überbreite, keine unbenannten Controls, 44-px-Ziele und AA-Kontraste sind grün; der allein außerhalb liegende Honeypot ist absichtlich unsichtbar. Der mobile Hero lädt `wagen-s-hero-960.webp` mit 54.622 Byte, Bricolage ohne ungenutzte Zusatzachsen. Fast-3G-/4×-CPU-Messung mit Brotli: LCP 2.100 ms, CLS 0, 342.243 Byte Transfer. Vor Maps-Zustimmung entstehen kein iframe, kein externer Request und kein Browser-Speicher. S/M/L-Kerndaten sind ohne Client-JavaScript lesbar. Spec-/Standards-Abgleich und Impeccable-Detector zeigen keine offenen P1/P2-Mängel. Der Mailer bleibt transparent deaktiviert.
