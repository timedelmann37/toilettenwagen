...
- Browsernatives Scroll-Snapping plus eine auf die Modellreise begrenzte Gesten-Normalisierung richtet die drei Stopps reproduzierbar an S, M und L aus. Ein Mausrad-/Trackpad-Gestus darf genau eine Station weiterführen.
...
- [x] An S, M und L gibt es browsernative Snap-Ziele in einem kompakten, gleichmäßigen Takt. Ein Gestus führt höchstens zur nächsten Station; Folgeereignisse desselben Gestus werden bis zum Einrasten gebunden.
...
- [x] Die Choreografie beginnt deutlich früher als im ersten Prototyp. Jede Scrollstrecke besitzt eine sichtbare inhaltliche Veränderung. Die Gestenbindung gilt nur innerhalb der S/M/L-Strecke und gibt den normalen Dokumentfluss oberhalb von S sowie unterhalb von L sofort frei.
